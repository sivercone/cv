         ...
         <div className="folder projects">
            ...
            <div className="folder__bottom">
               <div className="folder__bottom__file">
                  <a title="all projects" href="https://github.com/sivercone/" rel="noopener noreferrer" target="_blank">
                     <svg
                     ...
                     <div className="folder__bottom__txt">github.html</div>
                  </a>
               </div>
               <div className="folder__bottom__file">
                  <a
                     title="last project"
                     href="https://reactjs-game-store.herokuapp.com/"
                     ...
                     <div className="folder__bottom__txt">gamestore.html</div>
                  </a>
               </div>
               <div className="folder__bottom__file">
                  <a
                     title="last project"
                     href="https://github.com/sivercone/react-chat-lite"
                     rel="noopener noreferrer"
                     target="_blank">
                     <svg
                        className="folder__bottom__image"
                     ...
                     <div className="folder__bottom__txt">litechat.jsx</div>
                  </a>
               </div>
               <div className="folder__bottom__file">
                  <a
                     title="last project"
                     href="https://github.com/sivercone/react-twitter-clone"
                     rel="noopener noreferrer"
                     target="_blank">
                     <svg
                        className="folder__bottom__image"
                     ...
                     <div className="folder__bottom__txt">twitter-clone.tsx</div>
                  </a>
               </div>
               <div className="folder__bottom__file">
                  <a
                     title="last project"
                     href="https://github.com/sivercone/react-quizapp"
                     rel="noopener noreferrer"
                     target="_blank">
                     <svg
                        className="folder__bottom__image"
                     ...
                     <div className="folder__bottom__txt">quiz.tsx</div>
                  </a>
               </div>
            </div>
         </div>
